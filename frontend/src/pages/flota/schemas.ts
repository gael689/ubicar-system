...
export const vehiculoFormSchema = z.object({
  ...
  destino: z.enum(['alquiler', 'uber']),
  vtv_vencimiento: z.string().nullable().optional(),
  poliza_vencimiento: z.string().nullable().optional(),
  compania_seguro: z.string().max(150).nullable().optional(),
  nro_poliza: z.string().max(50).nullable().optional(),
});
